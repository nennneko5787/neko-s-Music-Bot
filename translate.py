...
TLANSLATION_DATA: dict[Locale, dict[str, str]]= {
	...
	Locale.ukrainian: {
		...
		"Close queue view": "Закрити перегляд черги"
	},
	Locale.russian: {
		...
		"Close queue view": "Закрыть просмотр очереди"
	},
	Locale.vietnamese: {
		...
		"Close queue view": "Đóng xem hàng đợi"
	},
	Locale.thai: {
